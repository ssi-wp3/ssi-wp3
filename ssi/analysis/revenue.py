...
def total_revenue_per_products(dataframe: pd.DataFrame,
    ...
    """
    return dataframe.groupby(product_id_column).apply(lambda x: total_revenue(x, amount_column, revenue_column))
...
def total_revenue_per_coicop(dataframe: pd.DataFrame,
    ...
    """
    return dataframe.groupby(coicop_column).apply(lambda x: total_revenue(x, amount_column, revenue_column))
...
def total_revenue_per_period(dataframe: pd.DataFrame,
    ...
    """
    return dataframe.groupby(period_column).apply(lambda x: total_revenue(x, amount_column, revenue_column))
...
def total_revenue_per_coicop_and_period(dataframe: pd.DataFrame,
    ...
    """
    return dataframe.groupby([period_column, coicop_column]).apply(lambda x: total_revenue(x, amount_column, revenue_column))
