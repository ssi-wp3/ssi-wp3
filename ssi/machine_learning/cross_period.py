...
class TrainModelOnPeriod(TrainModelTask):
    ...
    def fit_model(self,
        ...
        train_loader = DataLoader(
            train_set, batch_size=batch_size, shuffle=True, prefetch_factor=2, pin_memory=True, num_workers=1, drop_last=True)

        val_loader = DataLoader(
            val_set, batch_size=batch_size, shuffle=True, prefetch_factor=2, pin_memory=True, num_workers=1, drop_last=True)
